import FormStyling from "./StylingForm";
...
import StylingSlider from "./StylingSlider";
        ...
        <div id = "wd-lab2" className="container">
            ...
            <div id="wd-css-grid-layout">
                <div id="wd-css-left-right-layout">
                    <h2>Grid layout</h2>
                    {/* Each .wd-grid-row element ensures that the floating columns inside it do not affect other rows. 
                    Without clear: both, the floated elements might overlap with the next set of elements, disrupting the layout. */}
