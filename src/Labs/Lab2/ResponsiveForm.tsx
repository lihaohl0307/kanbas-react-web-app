    ...
    <div>
        <div id="wd-css-responsive-forms-1">
            ...
            <div className="mb-3 row">
                <label className="col-form-label col-sm-2" htmlFor="email1">
                    Email
                </label>
           ...
           <div className="mb-3 row">
                <label className="col-form-label col-sm-2" htmlFor="password1">
                    Password</label>
                <div className="col-sm-10">
           ...
           <div className="mb-3 row">
                <label className="col-form-label col-sm-2" htmlFor="textarea2">
                    Bio</label>
                <div className="col-sm-10">
